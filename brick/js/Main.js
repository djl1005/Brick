...
var mainScreen = function (game) {
    ...
    this.bomb = {
        ...
        constarin: function () {
            ...
            if (this.x > 500 - 25) this.x = 500 - 25;
            if (this.y < 75) this.y = 75;
            if (this.y > 350 - 75) this.y = 350 - 75;
        },
        ...
        colide: function (eX, eY, eR) {
            return (this.x - eX) * (this.x - eX) + (this.y - eY) * (this.y - eY) <= (this.r + eR) * (this.r + eR);
        }
    };
}
...
mainScreen.prototype = {
    ...
    create: function () {
        ...
        //bomb
        this.bomb.sprite = game.add.sprite(this.bomb.x, this.bomb.y, "bomb");
        this.bomb.sprite.anchor.setTo(0.5, 0.5);
        ...
        game.input.keyboard.addCallbacks(this, this.key);
